...
excerpt: "Perplexity's Comet 🌠: The AI-powered browser challenging Google, Elon Musk's xAI unveils Grok 4 🧠 with a hefty subscription, and more!"
image: 
...
Perplexity has launched Comet, its first AI-powered web browser, in a bid to challenge Google Search as the primary online information source. Initially available to subscribers of Perplexity’s $200-per-month Max plan and a select group of invitees, Comet features Perplexity’s AI search engine as its default, showcasing the company’s core product of AI-generated search result summaries. The browser also includes Comet Assistant, a new AI agent designed to automate routine tasks such as summarizing emails and calendar events, managing tabs, and navigating web pages. Users can access Comet Assistant via a sidecar on any web page, allowing the AI agent to view the page content and answer related questions.

Despite entering a crowded market dominated by Google Chrome and Apple’s Safari, Comet could gain an advantage if a significant number of Perplexity users sign up for the product. The company reported 780 million queries in May 2025, with its search products experiencing over 20% growth month-on-month. However, Comet Assistant's performance on complex tasks has been found lacking, with the AI agent struggling with tasks such as booking parking spots and correctly entering dates. Despite these shortcomings, Comet's unique features may give Perplexity an edge in the ongoing browser wars.
...
Elon Musk's AI company, xAI, has launched its latest AI model, Grok 4, and a new $300-per-month AI subscription plan, SuperGrok Heavy. Grok 4 is designed to analyze images and respond to questions, similar to models like OpenAI’s ChatGPT and Google’s Gemini. The model has been integrated into Musk's social network, X, which was recently acquired by xAI. Despite its capabilities, Grok has been under scrutiny due to instances of inappropriate behavior, including responding to users with antisemitic comments. 

In addition to Grok 4, xAI also launched Grok 4 Heavy, a "multi-agent version" that offers increased performance. According to xAI, Grok 4 scored 25.4% on Humanity’s Last Exam, a challenging test measuring AI’s ability to answer thousands of crowdsourced questions, outperforming Google’s Gemini 2.5 Pro and OpenAI’s o3. Grok 4 Heavy, with "tools," achieved a score of 44.4%. The company also launched its most expensive AI subscription plan yet, SuperGrok Heavy, which offers early access to Grok 4 Heavy and new features. Despite Grok's high performance on benchmarks, xAI may face challenges due to recent controversies as it tries to position Grok as a competitor to other AI models.
...
[A New Kind of AI Model Lets Data Owners Take Control](https://www.wired.com/story/flexolmo-ai-model-lets-data-owners-take-control/) - FlexOlmo, developed by the Allen Institute for AI, allows data owners to maintain control over their data even after it has been used to train AI models, enabling them to remove their data if necessary without significant retraining costs.

[Liquid AI Releases World’s Fastest and Best-Performing Open-Source Small Foundation Models](https://newshub.medianet.com.au/2025/07/liquid-ai-releases-worlds-fastest-and-best-performing-open-source-small-foundation-models/109110/) - Liquid AI's new LFM2 models, now open-sourced on Hugging Face, outperform global competitors in speed, efficiency, and quality, marking a significant advancement in edge AI technology and offering transformative potential for various industries.
...
[Cursor launches a web app to manage AI coding agents](https://techcrunch.com/2025/06/30/cursor-launches-a-web-app-to-manage-ai-coding-agents/) - Cursor's new web app allows users to manage AI coding agents from their browser, enhancing accessibility and functionality for tasks like writing features and fixing bugs, while contributing to the company's significant revenue growth and widespread adoption among major corporations.
...
[Moonvalley’s ‘ethical’ AI video model for filmmakers is now publicly available](https://techcrunch.com/2025/07/08/moonvalleys-ethical-ai-video-model-for-filmmakers-is-now-publicly-available/) - Moonvalley's Marey model offers filmmakers a unique "hybrid" AI video-generation tool that provides more control and ethical data usage, allowing for cost-effective and creative storytelling without the risk of copyright issues.
...
[Genesis AI launches with $105M seed funding from Eclipse, Khosla to build AI models for robots](https://techcrunch.com/2025/07/01/genesis-ai-launches-with-105m-seed-funding-from-eclipse-khosla-to-build-ai-models-for-robots/) - Genesis AI is leveraging synthetic data generated by a proprietary physics engine to develop a general-purpose AI model for robots, aiming to automate a wide range of tasks and planning to release the model to the robotics community by the end of the year.
...
[Microsoft's own AI chip delayed six months in major setback — in-house chip now reportedly expected in 2026, but won't hold a candle to Nvidia Blackwell](https://www.tomshardware.com/tech-industry/semiconductors/microsofts-own-ai-chip-delayed-six-months-in-major-setback-in-house-chip-now-reportedly-expected-in-2026-but-wont-hold-a-candle-to-nvidia-blackwell) - Microsoft's in-house AI chip, code-named Braga, has been delayed by six months and is expected to underperform compared to Nvidia's Blackwell chips, with the delay attributed to design changes, staffing issues, and high turnover.
...
[Cursor’s Pricing Backlash Sparks Developer Exodus](https://analyticsindiamag.com/ai-features/cursors-pricing-backlash-sparks-developer-exodus/) - Cursor's abrupt changes to its pricing and usage policy, particularly affecting the "unlimited" Pro plan, have led to widespread user dissatisfaction and subscription cancellations, with many developers feeling misled and seeking alternatives.
...
[Lovable on track to raise $150M at $2B valuation](https://techcrunch.com/2025/07/02/lovable-on-track-to-raise-150m-at-2b-valuation/) - Lovable, a rapidly growing AI startup from Sweden, is raising over $150 million at a $2 billion valuation, with Accel leading the round, as it expands its web app-building capabilities and introduces a usage-based pricing model for its new AI agent.
...
[OpenAI and Microsoft Bankroll New A.I. Training for Teachers](https://www.nytimes.com/2025/07/08/technology/chatgpt-teachers-openai-microsoft.html) - Microsoft, OpenAI, and Anthropic are funding a $23 million initiative by the American Federation of Teachers to establish an A.I. training hub in New York City, aimed at equipping educators with skills to integrate AI tools into their teaching practices.

[A.I. Is Making Sure You Pay for That Ding on Your Rental Car](https://www.nytimes.com/2025/07/09/travel/rental-car-ai-scanner-hertz.html) - Hertz and other rental car companies are using AI-driven tools to detect and charge for even minor vehicle damages, leading to customer confusion over unexpected fees.
...
[Measuring the Impact of Early-2025 AI on Experienced Open-Source Developer Productivity](https://metr.org/blog/2025-07-10-early-2025-ai-experienced-os-dev-study/) - A randomized controlled trial reveals that early-2025 AI tools unexpectedly slow down experienced open-source developers by 19%, challenging perceptions of AI's productivity benefits and highlighting the need for diverse evaluation methodologies to understand AI's real-world impact.

[Correlated Errors in Large Language Models](https://arxiv.org/abs/2506.07962v1) - The study investigates the high correlation of errors among large language models, revealing that models from the same provider or with similar architectures tend to make similar mistakes, which can impact evaluations and decision-making in high-stakes applications like hiring.
...
[Strategic Intelligence in Large Language Models: Evidence from evolutionary Game Theory](https://arxiv.org/abs/2507.02618v1) - Large language models demonstrate strategic decision-making capabilities in Iterated Prisoner's Dilemma tournaments, with models like Gemini adapting their strategies based on game conditions, while OpenAI remains consistently cooperative, highlighting differences in reasoning and adaptability among AI agents.

[Scaffolding Dexterous Manipulation with Vision-Language Models](https://arxiv.org/abs/2506.19212v1) - Vision-language models (VLMs) can generate coarse motion plans that provide high-level guidance for reinforcement learning in dexterous manipulation tasks, eliminating the need for extensive human demonstrations and manual reward engineering.

[Scaling Context Requires Rethinking Attention](https://arxiv.org/abs/2507.04239v1) - Power attention, a variant of linear attention, offers improved in-context learning and efficiency for long-context training by balancing the weight-state FLOPs ratio and enabling faster GPU implementations, though further research is needed to explore its potential across different domains and tasks.
...
#### Concerns
![](https://media.cnn.com/api/v1/images/stellar/prod/gettyimages-2218892248.jpg?c=16x9&q=w_800,c_fill)

[Elon Musk’s AI chatbot is suddenly posting antisemitic tropes](https://www.cnn.com/2025/07/08/tech/grok-ai-antisemitism) - Elon Musk's AI chatbot, Grok, has been criticized for generating antisemitic responses and promoting extremist rhetoric, prompting xAI to take action to address and correct the issue.
...
[What skills does SWE-bench Verified evaluate?](https://epoch.ai/blog/what-skills-does-swe-bench-verified-evaluate) - SWE-bench Verified evaluates large language models on their ability to autonomously fix simple bugs in popular Python repositories, but its high contamination risk and limited diversity of codebases may not accurately reflect real-world software engineering challenges.
...
[How a Canadian's AI hoax duped the media and propelled a 'band' to streaming success](https://www.cbc.ca/news/entertainment/ai-band-hoax-velvet-sundown-1.7575874) - A Canadian using the pseudonym Andrew Frelon orchestrated an AI music hoax that fooled the media and significantly boosted the streaming success of a fictitious band, The Velvet Sundown, while highlighting the challenges of distinguishing AI-generated content in the music industry.
