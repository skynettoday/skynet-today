...
excerpt: "AI Revolution: Unleashing the Power of Machine Learning, AI in Healthcare: A Game Changer, The Rise of AI in Financial Services, and more! 🚀🤖💡"
image: 
  feature: assets/img/digests/277/
...
[OpenAI’s ChatGPT for Mac is now available to all users](https://arstechnica.com/gadgets/2024/06/openais-chatgpt-for-mac-is-now-available-to-all-users/) - OpenAI's ChatGPT app for macOS is now available to all users, offering a desktop window version of the web app with support for various GPT models and a system-wide keyboard shortcut for prompt input.

[Figma announces big redesign with AI](https://www.theverge.com/2024/6/26/24183730/figma-ai-tools-app-redesign-slides) - Figma announces a major UI redesign and new generative AI tools to help users easily create projects, along with built-in slideshow functionality, all aimed at making the platform more approachable for new users and more efficient for experienced ones.
...
[Google Translate Just Added 110 More Languages](https://lifehacker.com/tech/google-translate-adds-110-new-languages) - Google Translate has added 110 new languages, including Cantonese and Punjabi, using its AI PaLM 2 large language model, bringing the total supported languages to nearly 250.
...
[Agility Robotics' Digit humanoids land first official job](https://www.therobotreport.com/agility-robotics-digit-humanoid-lands-first-official-job/) - Agility Robotics' Digit humanoids have landed their first official job with GXO Logistics Inc., marking a major milestone in the commercial deployment of humanoids in logistics operations.
...
[The A.I. Boom Has an Unlikely Early Winner: Wonky Consultants](https://www.nytimes.com/2024/06/26/technology/ai-consultants.html) - Consulting firms like Boston Consulting Group are experiencing a surge in demand for their services related to artificial intelligence, as companies seek guidance on how to leverage AI technology for their businesses.
...
[Andrew Ng plans to raise $120M for next AI Fund](https://techcrunch.com/2024/06/27/andrew-ng-plans-to-raise-120m-for-next-ai-fund/) - Andrew Ng plans to raise $120M for his second AI Fund, aiming to back small teams of experts solving key problems using AI.

[OpenAI delays ChatGPT’s new Voice Mode](https://techcrunch.com/2024/06/25/openai-delays-chatgpts-new-voice-mode/) - OpenAI delays the launch of ChatGPT's advanced Voice Mode due to lingering issues and the need for improvements, with the feature potentially not rolling out to all customers until the fall.

[Apple’s Devices Are Lasting Longer, Making AI Strategy Even More Critical](https://www.bloomberg.com/news/newsletters/2024-06-30/apple-s-longer-lasting-devices-ios-19-and-apple-intelligence-on-the-vision-pro-ly1jnrw4) - Apple's focus on extending the lifespan of its devices underscores the increasing importance of AI and software in its business strategy.

[Anthropic tries 'to enable beneficial uses' of AI by government agencies](https://www.theregister.com/2024/06/27/anthropic_claude_government/) - AI startup Anthropic aims to enable beneficial uses of AI by targeting government buyers through AWS Marketplace, with a focus on improving citizen services and policymaking while avoiding harmful applications.
...
[Manipulate-Anything: Automating Real-World Robots using Vision-Language Models](https://arxiv.org/abs/2406.18915v1) - Automating real-world robots using vision-language models is the focus of the article, which discusses the integration of AI technology into various applications.

[Efficacy of Language Model Self-Play in Non-Zero-Sum Games](https://arxiv.org/abs/2406.18872v1) - Language model self-play has shown efficacy in non-zero-sum games, as demonstrated in a paper available on arXiv.
...
[Building on Efficient Foundations: Effectively Training LLMs with Structured Feedforward Layers](https://arxiv.org/abs/2406.16450v1) - Training LLMs with structured feedforward layers is essential for efficient AI development and performance.

[MultiDiff: Consistent Novel View Synthesis from a Single Image](https://arxiv.org/abs/2406.18524v1) - A paper on novel view synthesis from a single image is not found on arXiv, and therefore cannot be cited on Hugging Face.
...
[The Center for Investigative Reporting is suing OpenAI and Microsoft](https://www.theverge.com/2024/6/28/24188239/openai-microsoft-center-for-investigative-reporting-lawsuit) - Nonprofit sues OpenAI and Microsoft for alleged copyright infringement, joining other media outlets in legal action over unauthorized use of content.
...
[AI scaling myths](https://www.aisnakeoil.com/p/ai-scaling-myths) - Bigger language models have shown improvement, but there are misconceptions about their continued scaling and potential for achieving artificial general intelligence.
...
[Large Language Models (Likely) Aren't the Future of Artificial General Intelligence, And That's Okay](https://jjacky.substack.com/p/large-language-models-likely-arent) - Large Language Models (LLMs) may not be the future of Artificial General Intelligence, but they can serve as the central processing unit, coordinating with specialized models to tackle a wide array of tasks in a modular and adaptable approach.

[Microsoft’s Mustafa Suleyman says he loves Sam Altman, believes he’s sincere about AI safety](https://techcrunch.com/2024/06/25/microsofts-mustafa-suleyman-says-he-loves-sam-altman-believes-hes-sincere-about-ai-safety/) - Mustafa Suleyman admires OpenAI CEO Sam Altman, trusts him on AI safety, and emphasizes the importance of cooperation and regulation in the AI industry, while also discussing the potential impact of AI in classrooms and the need to be cautious about fearing the downside of AI tools.
