---
title: "Bots, Lies, and DeepFakes — Online Misinformation, and AI's part in it"
author: [janny_zhang]
editor: [jacky_liang]
...
<figure class="half">
    <img src="{{ site.imgpath }}/editorials/2020-02-18-misinfo/im3.png"/>
    <figcaption>
...
<figure class="half">
    <img src="{{ site.imgpath }}/editorials/2020-02-18-misinfo/im6.png"/>
    <figcaption>
...
<figure class="half">
    <img src="{{ site.imgpath }}/editorials/2020-02-18-misinfo/im7.png"/>
    <figcaption>
...
In the academic sphere, OpenAI's language model [GPT-2](https://openai.com/blog/better-language-models/) is named in many places being able to generate entire fake text articles. 
They recently released the [most advanced version](https://openai.com/blog/gpt-2-1-5b-release/), which you can [demo online here](https://talktotransformer.com/), but OpenAI reports that they've "seen no strong evidence of misuse so far."
...
<figure class="half">
    <img src="{{ site.imgpath }}/editorials/2020-02-18-misinfo/im16.png"/>
    <figcaption>
